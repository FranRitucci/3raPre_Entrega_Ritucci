//Variable carrito con una funcion para que detecte si existen valores previos en el storage
let carrito = cargarCarrito();
//Variable productosJSON para trabajar con la funcion obtenerJSON
let productosJSON = [];
...
$(document).ready(function () {
  ...
  //config del selector para ordenar productos
...
function ordenarProductos() {
  ...
  //Renderizar luego del reordenamiento
  $(".card-product").remove();
  renderizarProductos();
}
...
function agregarAlCarrito(productoAgregado) {
  ...
  if (encontrado == undefined) {
    ...
    //Nueva fila a la tabla de carrito en caso de que el producto no se encontrara 
...
//function para rehacer la tabla del modal cada vez que se refresca la pagina y eliminar productos del carrito
...
//Calcular el monto total del carrito y la cantidad
...
//Reset de los valores una vez finalizada la compra 
...
//FUNCTION para traer el carrito cargado cada vez que se refresca la pagina
